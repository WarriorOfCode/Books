...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 17, 2016 at 11:34 PM
...
--
-- Table structure for table `authors_groups`
--
...
--
-- Table structure for table `books_groups`
--
...
--
-- Dumping data for table `books_groups`
--
...
--
-- Constraints for table `authors_groups`
--
...
--
-- Constraints for table `books_groups`
--
...
ALTER TABLE `books_reviews`
  ADD CONSTRAINT `FK_books_reviews_books` FOREIGN KEY (`id_book`) REFERENCES `books` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_books_reviews_reviews` FOREIGN KEY (`id_review`) REFERENCES `reviews` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `users_review`
  ADD CONSTRAINT `FK_users_review_reviews` FOREIGN KEY (`id_review`) REFERENCES `reviews` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_users_review_users` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
