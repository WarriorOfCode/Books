...
INSERT INTO `Authors` (`id`, `Name`, `Last_Name`, `patronymic`, `Birth_date`, `Biography`, `Counry_of_birth`, `image_url`) VALUES
	...
	(6, 'Евгения', 'Кана', NULL, '1988-11-10', 'Знание - это боль', 'Брест', ''),
	(7, 'Саша', 'Пушкин', NULL, NULL, 'Хороший мужик', 'Россия', ''),
...
-- Dumping data for table Books_DB.Books: ~12 rows (approximately)
/*!40000 ALTER TABLE `Books` DISABLE KEYS */;
INSERT INTO `Books` (`id`, `Name`, `Birth_data`, `Description`, `ISBN`, `image_url`) VALUES
	(34, 'Мастер и маргарита', 127, 'Роман Михаила Афанасьевича Булгакова, работа над которым началась в конце 1920-х годов и продолжалась вплоть до смерти писателя. Роман относится к незавершённым произведениям; редактирование и сведение воедино черновых записей осуществляла после смерти мужа вдова писателя — Елена Сергеевна. Первая версия романа, имевшая названия «Копыто инженера», «Чёрный маг» и другие, была уничтожена Булгаковым в 1930 году. В последующих редакциях среди героев произведения появились автор романа о Понтии Пилате и его возлюбленная. Окончательное название — «Мастер и Маргарита» — оформилось в 1937 году.', 0000000000000, '/images/34.jpg'),
...
-- Dumping data for table Books_DB.books_authors: ~12 rows (approximately)
...
-- Dumping data for table Books_DB.books_groups: ~4 rows (approximately)
...
-- Dumping data for table Books_DB.books_users: ~15 rows (approximately)
...
-- Dumping data for table Books_DB.Groups: ~1 rows (approximately)
